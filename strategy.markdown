...
The requirements document takes about 60 hours to produce, including all discovery, research and meetings.
...
(Sometimes called a [Functional Requirement](http://en.wikipedia.org/wiki/Functional_requirement).)
...
Typically takes 90–170 person-hours to produce, including all discovery, research and meetings.
 ...
 - Restates scope of production phase
 - Must be approved by the client
 - Includes everything in a Requirements document, *plus*:
